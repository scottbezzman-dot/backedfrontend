...
export const metadata: Metadata = {
  title: "Identity Verification || Quantum Fianancial System crypto app",
      ...
      <>
        ...
        <div className="pt-45 pb-16">
          <div className="tf-container">
            ...
            <div className="text-center mt-60 mb-60">
              ...
              >
                ...
                <path
                  ...
                  fill="white"
                />
                <path d="M124 2L124 37" stroke="white" strokeWidth={3} />
                <path
                  d="M124 2H89"
                  stroke="white"
                  strokeWidth={3}
                  strokeLinecap="round"
                />
                <path d="M2 2L2 37" stroke="white" strokeWidth={3} />
                <path
                  d="M2 2H37"
                  stroke="white"
                  strokeWidth={3}
                  strokeLinecap="round"
                />
                <path d="M124 95L124 60" stroke="white" strokeWidth={3} />
                <path
                  d="M124 95H89"
                  stroke="white"
                  strokeWidth={3}
                  strokeLinecap="round"
                />
                <path d="M2 95L2 60" stroke="white" strokeWidth={3} />
                <path
                  d="M2 95H37"
                  stroke="white"
                  strokeWidth={3}
            ...
            <Link href={`/camera-scan`} className="tf-btn lg primary mt-40">
              Next
            </Link>
          </div>
        </div>
